...
export class ZKShuffle {
    ...
    generate_shuffle_proof(gameId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield generateShuffleEncryptV2Proof(aggrPK, A, R, preprocessedDeck.X0, preprocessedDeck.X1, preprocessedDeck.Delta[0], preprocessedDeck.Delta[1], preprocessedDeck.Selector, plaintext_output.X0, plaintext_output.X1, plaintext_output.delta0, plaintext_output.delta1, plaintext_output.selector, this.encrypt_wasm, this.encrypt_zkey);
        });
    }
    _shuffle(gameId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    decrypt(gameId, cards) {
        return __awaiter(this, void 0, void 0, function* () {
            const numCards = (yield this.smc.getNumCards(gameId)).toNumber();
            yield dealMultiCompressedCard(this.babyjub, numCards, gameId, cards, this.sk, this.pk, this.smc, this.decrypt_wasm, this.decrypt_zkey);
        });
    }
    ...
    getOpenProof(gameId, cardIds) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < cardIds.length; i++) {
                ...
                cardMap += 1 << cardId;
                const decryptProof = yield generateDecryptProof([
