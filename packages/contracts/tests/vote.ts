...
import generateSignalProof, { Identity, packToSolidityProof, poseidon, poseidon_gencontract as poseidonContract, SolidityProof } from '@poseidon-zkp/poseidon-zk-proof/src/signal/proof';
import generateGroupProof, { Group } from '@poseidon-zkp/poseidon-zk-proof/src/group/proof';
