...
import generateProof, { Group, Identity, packToSolidityProof, poseidon, poseidon_gencontract as poseidonContract, SolidityProof } from '@p0x-labs/poseidon-zk-proof/src/group/proof';
