...
export interface DecryptVerifierInterface extends utils.Interface {
  functions: {
...
export interface DecryptVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DecryptVerifierInterface;
